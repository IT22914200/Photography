...
const CreateUpdatePostModal = ({ isOpen, onClose, initialPost = null,onSubmitSuccess }) => {
  ...
  return (
    ...
    >
      <div className="bg-gradient-to-r from-purple-500 to-indigo-600 rounded-t-lg p-5 animate-gradient-x">
      ...
      <form onSubmit={handleSubmit} className="p-6 space-y-6 bg-white rounded-b-lg">
        <div>
          ...
          <input
            ...
            className="block w-full rounded-lg border-gray-300 shadow-sm focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition duration-200"
        ...
        <div className="space-y-3">
          ...
          <div className="flex flex-col space-y-2">
            <div className="flex items-center">
              <label className={`flex items-center justify-center w-full px-4 py-3 rounded-lg border-2 border-dashed ${mediaPreview.length >= 3 ? 'bg-gray-100 border-gray-300 cursor-not-allowed' : 'border-purple-400 hover:border-purple-500 bg-purple-50 hover:bg-purple-100 cursor-pointer transition-colors duration-200'}`}>
                ...
                <div key={index} className="relative group">
                  ...
                  {uploadProgress[index] !== undefined && !media.existingMedia && (
                    <div className="absolute bottom-0 left-0 w-full bg-gray-200 h-2 rounded-b-lg">
                      <div 
                        className="bg-purple-500 h-2 rounded-bl-lg transition-all duration-300" 
        ...
        <div className="pt-4 border-t border-gray-200">
          <div className="flex justify-end space-x-3">
            ...
            <button
              type="submit"
              className="px-5 py-2.5 rounded-lg text-sm font-medium text-white bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 shadow-sm transition duration-200 disabled:opacity-70 disabled:cursor-not-allowed"
              disabled={isLoading}
            >
              {isLoading ? (
