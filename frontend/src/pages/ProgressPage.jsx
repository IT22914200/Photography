  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-8">
        ...
        {userId && (
          <button
            ...
            className="px-4 py-2 bg-gradient-to-r from-purple-500 to-indigo-600 text-white rounded-lg hover:from-purple-600 hover:to-indigo-700 transition-all duration-300 shadow-md flex items-center"
          >
      ...
      {progressUpdates.length === 0 ? (
        <div className="bg-purple-50 border border-purple-100 text-purple-700 p-8 rounded-lg text-center">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {progressUpdates.map((progress) => (
            ...
            >
              <div className={`px-4 py-3 text-white ${progress.goalsAchieved ? 'bg-gradient-to-r from-purple-500 to-blue-500' : 'bg-gradient-to-r from-purple-500 to-indigo-600'}`}>
                ...
                {userId === progress.userId && (
                  <div className="flex justify-end space-x-2 mt-4">
                    <button
                      ...
                      className="px-3 py-1 text-sm text-purple-600 hover:text-purple-800 border border-purple-200 rounded hover:bg-purple-50 transition-colors"
                    >
                      Edit
                    </button>
                    <button
